...
const QUOTES = [
  ...
  // └──────────────────────────────────────────┘
  ```js
{ text: "The only journey is the one within.", author: "Rainer Maria Rilke", category: "poem" },
{ text: "Even on the hardest morning the light finds you. Stand in it. Let it be enough.", author: "original — in the spirit of Mary Oliver", category: "poem" },
{ text: "Go slowly. The flowers do not rush and they are the most beautiful things in the world.", author: "original — in the spirit of Mary Oliver", category: "poem" },
{ text: "The future enters into us long before it happens.", author: "Rainer Maria Rilke", category: "poem" },
{ text: "You are worth finding, worth knowing, worth loving.", author: "Atticus", category: "poem" },
{ text: "You have been soft and strong in the same breath — do you know how rare that is?", author: "original — in the spirit of Mary Oliver", category: "poem" },
{ text: "she was not looking for someone to complete her — she had been whole this entire time, just learning the shape of her own edges", author: "original — in the spirit of Atticus", category: "poem" },
{ text: "she learned to hold herself the way she had always wanted someone else to — and that changed everything", author: "original — in the spirit of Warsan Shire", category: "poem" },
{ text: "she wore her scars not as wounds but as maps of every hard place she had walked through and survived", author: "original — in the spirit of Atticus", category: "poem" },
{ text: "there is a kind of woman who builds things quietly — herself, first, then everything else", author: "original — in the spirit of Atticus", category: "poem" },
{ text: "she speaks and whole rooms rearrange themselves around her voice — she has always had that kind of power", author: "original — in the spirit of Warsan Shire", category: "poem" },
{ text: "you survived every hard day until now. your record is perfect.", author: "original — in the spirit of Rupi Kaur", category: "poem" },
{ text: "I live my life in widening circles that reach out across the world.", author: "Rainer Maria Rilke", category: "poem" },
{ text: "You must give birth to your images. They are the future waiting to be born.", author: "Rainer Maria Rilke", category: "poem" },
{ text: "You do not just wake up and become the butterfly. Growth is a process.", author: "Rupi Kaur", category: "poem" },
{ text: "she is not too much. the world was just not big enough for what she was becoming.", author: "original — in the spirit of Rupi Kaur", category: "poem" },
{ text: "There is still so much that wants to love you — the morning, the cup of tea, your own two hands.", author: "original — in the spirit of Mary Oliver", category: "poem" },
{ text: "you are allowed to be both the wound and the one who heals it", author: "original — in the spirit of Warsan Shire", category: "poem" },
{ text: "it is okay to need rest — even the sun sets every single night", author: "original — in the spirit of Rupi Kaur", category: "poem" },
{ text: "I want to be with those who know secret things, or else alone.", author: "Rainer Maria Rilke", category: "poem" },
{ text: "You are a girl made of both fire and healing water.", author: "Warsan Shire", category: "poem" },
{ text: "some days she was the storm and some days she was the calm after — but she was always the sky", author: "original — in the spirit of Atticus", category: "poem" },
{ text: "What if you stopped apologizing for taking up space — the oak never asks permission to grow", author: "original — in the spirit of Mary Oliver", category: "poem" },
{ text: "you came from women who survived. carry that with you on the days you are not sure you will.", author: "original — in the spirit of Warsan Shire", category: "poem" },
{ text: "your softness is not weakness — it is the most radical thing you have ever offered a world that keeps asking you to harden", author: "original — in the spirit of Warsan Shire", category: "poem" },
{ text: "the women before you also cried on the bathroom floor and got back up. you come from that.", author: "original — in the spirit of Rupi Kaur", category: "poem" },
{ text: "Perhaps all the dragons in our lives are princesses who are only waiting to see us act, just once, with beauty and courage.", author: "Rainer Maria Rilke", category: "poem" },
{ text: "Tell me, what is it you plan to do with your one wild and precious life?", author: "Mary Oliver", category: "poem" },
{ text: "she stopped waiting to be chosen and chose herself and that was the bravest thing anyone had ever seen", author: "original — in the spirit of Atticus", category: "poem" },
{ text: "this is not starting over. this is continuing — with everything you now know.", author: "original — in the spirit of Rupi Kaur", category: "poem" },
 ...
 // ┌──────────────────────────────────────────┐
  ...
  // └──────────────────────────────────────────┘
  { text: "You are my favorite adventure, and every moment with you feels like coming home.", author: "Rafael G.", category: "amorcito" },
  { text: "I fell in love with the way you fall asleep — slowly, then all at once, like the world finally feels safe.", author: "Rafael G.", category: "amorcito" },
  { text: "You make the ordinary feel extraordinary. A walk, a coffee, a silence — everything shines with you.", author: "Rafael G.", category: "amorcito" },
  { text: "My favorite place in the entire world is right next to you.", author: "Rafael G.", category: "amorcito" },
  { text: "Every picture of us is a reminder: life smiled the day I met you.", author: "Rafael G.", category: "amorcito" },
  { text: "You are my calm in the chaos, my warmth in the cold, my light in the dark.", author: "Rafael G.", category: "amorcito" },
  { text: "I didn't know what home felt like until I found you.", author: "Rafael G.", category: "amorcito" },
  { text: "Thank you for being my person — my partner, my peace, my favorite human.", author: "Rafael G.", category: "amorcito" },
  { text: "With you, I learned that love isn't just a feeling — it's a garden we grow together, every single day.", author: "Rafael G.", category: "amorcito" },
  { text: "Ronja, you are the most beautiful chapter in my story.", author: "Rafael G.", category: "amorcito" },
];
